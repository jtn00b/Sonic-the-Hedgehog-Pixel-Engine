...
switch mode{
    ...
    case 2:
        ...
        (collision_line(sensor_d_x, center_y, sensor_d_x, sensor_d_y, par_monitors, true, true) && !(spin && ((sign(ysp) = 1 && !ground) || ground))) ||
    ...
    case 3:
        ...
        (collision_line(center_x, sensor_d_y, sensor_d_x, sensor_d_y, par_monitors, true, true) && !(spin && ((sign(ysp) = 1 && !ground) || ground))) ||
